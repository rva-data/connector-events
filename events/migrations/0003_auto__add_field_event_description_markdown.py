...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.description_markdown'
        db.add_column(u'events_event', 'description_markdown',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.description_markdown'
        db.delete_column(u'events_event', 'description_markdown')
